...
//    NSLog(@"%ld", (long)self.selectedSegmentIndex);
...
- (void)updateSegmentsRects:(CGSize)size
{
    ...
    if (CGRectIsEmpty(self.frame)) {
        ...
        for (NSString *titleString in self.sectionTitles) {
            CGFloat stringHeight = [self getTextHeight:NSLocalizedString(titleString, @"")] + self.segmentEdgeInset.top + self.segmentEdgeInset.bottom;
